  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      <Card className="bg-white/60 backdrop-blur-sm border-slate-200/60 shadow-md rounded-2xl overflow-hidden">
        <CardHeader className="pb-3">
          <CardTitle className="text-sm font-semibold text-slate-600 flex items-center gap-1.5">
            <Users className="w-4 h-4 text-yooga-primary" />
      ...
      <Card className="bg-white/60 backdrop-blur-sm border-slate-200/60 shadow-md rounded-2xl overflow-hidden">
        ...
        <CardContent>
          <div className="text-3xl font-extrabold text-yooga-accent">{filteredCerts.length}</div>
      ...
      <Card className="bg-white/60 backdrop-blur-sm border-slate-200/60 shadow-md rounded-2xl overflow-hidden">
        <CardHeader className="pb-3">
          <CardTitle className="text-sm font-semibold text-slate-600 flex items-center gap-1.5">
            <Award className="w-4 h-4 text-yooga-accent" />
            Pontuação Média de CS
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="text-3xl font-extrabold text-yooga-secondary">{averageScore}%</div>
