...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#001D42] via-[#002D62] to-[#004094] px-4 py-12">
      ...
      <div className="w-full max-w-md z-10 space-y-6">
        <div className="text-center space-y-2">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-tr from-[#002D62] to-[#FF6600] shadow-lg shadow-blue-900/30 mb-2">
          ...
          <form onSubmit={handleSubmit}>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 bg-slate-950/50 border-slate-800 text-slate-100 placeholder-slate-600 focus-visible:ring-blue-500 focus-visible:ring-offset-slate-950 h-11 rounded-xl"
                    required
                  />
                </div>
              </div>
            ...
            <CardFooter className="flex flex-col gap-4">
              <Button
                ...
                className="w-full bg-[#FF6600] hover:bg-[#e65c00] text-white font-bold h-11 rounded-xl shadow-lg shadow-orange-500/10 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 cursor-pointer"
              >
